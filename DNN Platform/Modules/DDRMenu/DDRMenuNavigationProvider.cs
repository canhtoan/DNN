...
namespace DotNetNuke.Web.DDRMenu
{
    public class DDRMenuNavigationProvider : NavigationProvider
    {
        ...
        private DDRMenuControl _menuControl;

        public override Control NavigationControl { get { return _menuControl; } }
        ...
        {
            _menuControl = new DDRMenuControl { ID = ControlID, EnableViewState = false };
            _menuControl.NodeClick += RaiseEvent_NodeClick;
        }
        ...
        public void Bind(DNNNodeCollection objNodes, bool localise)
        {
            ...
            _menuControl.RootNode = new MenuNode(objNodes);
            _menuControl.SkipLocalisation = !localise;
            _menuControl.MenuSettings = new Settings
            {

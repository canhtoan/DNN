...
namespace DotNetNuke.Web.DDRMenu
{
    public class Settings
    {
        ...
        public List<ClientOption> ClientOptions { get { return _clientOptions ?? (_clientOptions = new List<ClientOption>()); } set { _clientOptions = value; } }

        private List<TemplateArgument> _templateArguments;
        public List<TemplateArgument> TemplateArguments { get { return _templateArguments ?? (_templateArguments = new List<TemplateArgument>()); } set { _templateArguments = value; } }
